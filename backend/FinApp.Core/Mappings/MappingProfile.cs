...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        // PpkBendahara mappings
        CreateMap<PpkBendahara, PpkBendaharaDto>()
            .ForMember(dest => dest.JabatanName, opt => opt.MapFrom(src => src.Jabatan.ToString()));
        CreateMap<CreatePpkBendaharaDto, PpkBendahara>();
        CreateMap<UpdatePpkBendaharaDto, PpkBendahara>()
        ...
        CreateMap<Stpb, StpbDto>()
            ...
            .ForMember(dest => dest.Details, opt => opt.MapFrom(src => src.StpbDetails))
        ...
        CreateMap<CreateStpbDto, Stpb>()
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => StpbStatus.Draft))
            .ForMember(dest => dest.TotalNilai, opt => opt.Ignore())
            .ForMember(dest => dest.StpbDetails, opt => opt.Ignore());
        
        CreateMap<UpdateStpbDto, Stpb>()
            .ForMember(dest => dest.Id, opt => opt.Ignore())
            .ForMember(dest => dest.NomorSTPB, opt => opt.Ignore())
            .ForMember(dest => dest.Tahun, opt => opt.Ignore())
